...
WOS_V2_INTEGRATION_ACCOUNTS_JSON={"routes":[{"tracker_account_ref":"11111111-1111-4111-8111-111111111111","qbittorrent_account_ref":"22222222-2222-4222-8222-222222222222","newgreedy_url":"http://newgreedy:8080","c411_passkey":"ci-only-not-a-real-passkey","qbittorrent_url":"http://qbittorrent:8080","qbittorrent_username":"ci-only","qbittorrent_password":"ci-only-disposable-test-password"}]}
