...
class SandboxedFileMutator:
    ...
    @staticmethod
    def _source_path(raw_path: str) -> RelativePath:
    ...
    def _relocate(
        ...
        with (
            ...
            source_stat = self._inspect_source(source_parent_fd, source_name)
            ...
            try:
                ...
                self._rollback(
                    ...
                    source_directory_fd=destination_parent_fd,
                    destination_directory_fd=source_parent_fd,
                )
            ...
            if (
                ...
                or entry_kind(destination_stat.st_mode) is not source_kind
            ):
                self._rollback(
                    source_name=destination_name,
                    destination_name=source_name,
    ...
    @staticmethod
    def _inspect_source(parent_fd: int, name: str) -> os.stat_result:
        try:
