...
`V2-28A — Autorité scheduler et slots de téléchargement` est la prochaine tâche non terminée.
V2-29 ne commence qu'après fusion séparée de V2-28A à V2-28H. Cette phase documentaire ne
commence aucune de ces implémentations.
