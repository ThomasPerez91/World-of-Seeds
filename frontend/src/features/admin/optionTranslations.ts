...
const englishOptions: Record<string, OptionCopy> = {
  ...
  WOS_DOWNLOAD_MAX_CONCURRENT_GLOBAL: { label: "Global HTTP downloads", description: "Maximum open HTTP file streams across all accounts, including administrators." },
  ...
  WOS_SCHEDULER_DYNAMIC_CONCURRENCY_ENABLED: { label: "Dynamic download regulation", description: "Gradually adapts qBittorrent concurrency to the average observed download rate." },
  WOS_SCHEDULER_DYNAMIC_INITIAL_ACTIVE: { label: "Initial dynamic limit", description: "Downloads admitted at the beginning of each new series." },
  WOS_SCHEDULER_DYNAMIC_MIN_BYTES_PER_SECOND: { label: "Dynamic minimum rate", description: "Average rate below which another download may be admitted." },
  WOS_SCHEDULER_DYNAMIC_TARGET_BYTES_PER_SECOND: { label: "Dynamic maximum target rate", description: "Upper target bound; exceeding it never pauses a torrent." },
  WOS_SCHEDULER_DYNAMIC_EVALUATION_SECONDS: { label: "Dynamic evaluation period", description: "Complete measurement duration required before another capacity decision." },
  WOS_SCHEDULER_DYNAMIC_STEP: { label: "Dynamic increment", description: "Downloads added when the observed average remains below target." },
  WOS_SCHEDULER_DYNAMIC_MAX_ACTIVE: { label: "Dynamic hard cap", description: "Maximum downloads admitted by dynamic regulation." },
  ...
  WOS_SCHEDULER_CONTROL_INTERVAL_SECONDS: { label: "Scheduler time quantum", description: "Minimum delay between two fair redistributions of qBittorrent slots." },
...
const frenchOptions: Record<string, OptionCopy> = {
  ...
  WOS_DOWNLOAD_MAX_CONCURRENT_GLOBAL: { label: "Téléchargements HTTP globaux", description: "Nombre maximal de flux de fichiers ouverts, administrateurs inclus." },
  ...
  WOS_SCHEDULER_DYNAMIC_CONCURRENCY_ENABLED: { label: "Régulation dynamique des téléchargements", description: "Adapte progressivement la concurrence qBittorrent au débit moyen observé." },
  WOS_SCHEDULER_DYNAMIC_INITIAL_ACTIVE: { label: "Limite dynamique initiale", description: "Téléchargements admis au début de chaque nouvelle série." },
  WOS_SCHEDULER_DYNAMIC_MIN_BYTES_PER_SECOND: { label: "Débit minimal dynamique", description: "Débit moyen sous lequel un téléchargement supplémentaire peut être admis." },
  WOS_SCHEDULER_DYNAMIC_TARGET_BYTES_PER_SECOND: { label: "Débit cible maximal dynamique", description: "Borne haute cible ; son dépassement ne met jamais un torrent en pause." },
  WOS_SCHEDULER_DYNAMIC_EVALUATION_SECONDS: { label: "Période d’évaluation dynamique", description: "Durée de mesure complète avant une nouvelle décision de capacité." },
  WOS_SCHEDULER_DYNAMIC_STEP: { label: "Palier dynamique", description: "Téléchargements ajoutés lorsque le débit moyen reste insuffisant." },
  WOS_SCHEDULER_DYNAMIC_MAX_ACTIVE: { label: "Plafond dynamique absolu", description: "Nombre maximal de téléchargements admis par la régulation dynamique." },
  ...
  WOS_SCHEDULER_CONTROL_INTERVAL_SECONDS: { label: "Quantum du scheduler", description: "Délai minimal entre deux redistributions équitables des slots qBittorrent." },
